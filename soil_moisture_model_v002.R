# Soil Moisture & Precip are included in the model
...
plot(time,ci[2,],type='n',ylim=range(ci,na.rm=TRUE),ylab="SoilMoisture",xlim=time[time.rng], main='SoilMoistureFusion')
